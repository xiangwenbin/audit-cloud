...
(function(factory) {
    ...
    _e(function(E, $) {
        ...
        // Txt.fn.addCtrlShiftVEvent = function() {
        ...
        Txt.fn.bindPasteFilter = function() {
            ...
            $txt.on('paste', function(e) {
                ...
                // 执行命令
                if (resultHtml) {
                    let _filterHtml = xss(resultHtml, {
                        // whiteList: ["div", "a", "b", "u", "br", "span", "p", "img", "h1", "h2", "h3", "h4", "h5", "h6", "font", "blockquote", "table", "tbody", "tfoot", "tr", "th", "td", "ul", "ol"],
                        whiteList: {
                            a: ['href', 'target'],
                        ...
                        onTagAttr: function(tag, name, value, isWhiteAttr) {
                            if (tag === 'img' && name === 'src') {
                                if (value.indexOf("fs.cdn.huitax.com") === -1) {
                                    return "src='https://fs.cdn.huitax.com/data/1496817996328.png'";
                                }
                            }
                        }
                    });
                    editor.command(e, 'insertHtml', _filterHtml);
